...
import { Layers, Eye, EyeOff, Settings, Info, Palette, Wrench, Map as MapIcon, X } from "lucide-react";
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <div className="space-y-2">
                <div className="h-4 bg-gradient-to-r from-blue-200 via-green-300 to-red-400 rounded"></div>
