      ...
      <Card className="overflow-hidden">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                ...
                <Input id="email" name="email" type="email" placeholder="m@example.com" className={error
                  ? "border-red-500" : "" } onChange={()=> setError(null)}
                required
                />
              </div>
              <div className="grid gap-2">
                ...
                <Input id="password" name="password" type="password" required className={error ? "border-red-500" : "" }
          ...
          <div className="relative hidden bg-muted md:block">
            <img src="/placeholder.svg" alt="placeholder img"
